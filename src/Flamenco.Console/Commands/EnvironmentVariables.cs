...
public static class EnvironmentVariables
{
    ...
    public static bool TryGetDebianTarballCompressionMethodFromEnvironmentOrDefaultIfNull(
        [NotNullWhen(returnValue: true)] ref TarballCompressionMethod? compressionMethod) =>
        ...
        [NotNullWhen(returnValue: true)] ref TarballCompressionMethod? compressionMethod)
    {
        ...
        {
            compressionMethod = TarballCompressionMethod.XZ;
            return true;
        }

        if (value.Equals("gzip", StringComparison.OrdinalIgnoreCase))
        {
            compressionMethod = TarballCompressionMethod.GZip;
            return true;
        }

        if (value.Equals("none", StringComparison.OrdinalIgnoreCase))
        {
            compressionMethod = TarballCompressionMethod.None;
            return true;
        }
