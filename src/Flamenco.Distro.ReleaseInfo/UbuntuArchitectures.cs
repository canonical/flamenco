...
public static class UbuntuArchitectures
{
    static UbuntuArchitectures()
    {
        var officialPorts = ImmutableArray.CreateBuilder<DpkgArchitecture>(initialCapacity: 8);
        ...
        officialPorts.Add(DpkgArchitecture.PowerPc);
