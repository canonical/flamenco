...
// See http://ftp.us.debian.org/debian/dists/ as a reference
public static class DebianPockets
{
    ...
    public static readonly DpkgPocket ProposedUpdates = DpkgPocket.Parse("proposed-updates");
    public static readonly DpkgPocket Backports = DpkgPocket.Parse("backports");

    public static readonly ImmutableArray<DpkgPocket> All;

    static DebianPockets()
    {
        All = [ Release, Updates, ProposedUpdates, Backports ];
    }
}
